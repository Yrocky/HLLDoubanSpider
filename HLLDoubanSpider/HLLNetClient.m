...
- (void) requestDataWithMethodType:(NetworkMethodType)method
    ...
    switch (method) {
        case GET:
        {
            [self GET:urlPath parameters:params progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        case POST:
        {
            [self POST:urlPath parameters:params progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        case PUT:
        {
            [self PUT:urlPath parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        ...
        case DELETE:
        {
            [self DELETE:urlPath parameters:params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
